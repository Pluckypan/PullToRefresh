...
import engineer.echo.pulltorefresh.library.internal.FlipLoadingLayout;
import engineer.echo.pulltorefresh.library.internal.LoadingLayout;
import engineer.echo.pulltorefresh.library.internal.RotateLoadingLayout;
import engineer.echo.pulltorefresh.library.internal.Utils;
import engineer.echo.pulltorefresh.library.internal.ViewCompat;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout implements IPullToRefresh<T> {
    ...
    protected final void onRestoreInstanceState(Parcelable state) {
        try {
            ...
            Log.d("Plucky", "Android's fucking crash of the same id");
        }

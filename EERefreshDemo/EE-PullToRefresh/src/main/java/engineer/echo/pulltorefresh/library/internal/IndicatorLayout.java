...
public class IndicatorLayout extends FrameLayout implements AnimationListener {
    ...
    public IndicatorLayout(Context context, PullToRefreshBase.Mode mode) {
        ...
        int arrowWidth = arrowD != null ? arrowD.getIntrinsicWidth() : 0;
        int arrowHeight = arrowD != null ? arrowD.getIntrinsicHeight() : 0;
        ...
        switch (mode) {
            case PULL_FROM_END:
                ...
                matrix.setRotate(180f, arrowWidth / 2f, arrowHeight / 2f);
